...
const PORTRAIT_PATHS = Object.freeze({
  heroes: {
    fate: "assets/portraits/hero-fate.png",
    blood: "assets/portraits/hero-blood.png",
    poison: "assets/portraits/hero-poison.png",
  },
  enemies: {
    shanxiao: "assets/portraits/enemy-shanxiao.png",
    rottenShanxiao: "assets/portraits/enemy-shanxiao.png",
    bloodwolf: "assets/portraits/enemy-bloodwolf.png",
    redManeBloodwolf: "assets/portraits/enemy-bloodwolf.png",
    bloodwolfElite: "assets/portraits/enemy-bloodwolf.png",
    beeswarm: "assets/portraits/enemy-beeswarm.png",
    wildBeeTide: "assets/portraits/enemy-beeswarm.png",
    corpsepuppet: "assets/portraits/enemy-corpsepuppet.png",
    corpsepuppetPhase2: "assets/portraits/enemy-corpsepuppet-phase2.png",
  },
});
...
const GAME_VERSION = "V0.9.2.3 公开网页音频与移动端热修";
...
function renderHand() {
  ...
  dom.hand.innerHTML = game.hand.map((card) => {
    ...
    const combatCardName = card.baseName || CARD_LIBRARY[card.key]?.name || stripTags(card.name);
    return `
