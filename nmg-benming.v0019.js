...
const BENMING_STAGES = Object.freeze([
  ...
  /* V0.9.51 长尾（用户反馈"很多玩家已满级"）：五转以上再开四个原创九转成长里程碑。
...
const BENMING_META_UNLOCKS = Object.freeze({
  5: "入塔可携带 3 只随行蛊",
  6: "蛊庐开放第 8 圃（六转共 8 圃）",
  7: "蛊庐开放第 9 圃 · 入塔可携带 4 只随行蛊",
  8: "蛊庐开放第 10 圃 · 蛊卵孵化时间缩短 20%",
  9: "蛊庐开放第 11、12 圃 · 入塔可携带 5 只随行蛊 · 得「九转」称号",
});
...
const BENMING_GU = Object.freeze({
  fate: {
    ...
    stagePassives: ["尚在卵中沉睡。", "开局命势 +1。", "每场首次命势圆满时，额外抽 1 张牌。", "每局开局从「三相织命 / 噬签改命」中选择一条互斥路线。", "开局命势再 +1（累计 +2）。", "所选路线获得五转强化；入塔可携带 3 只随行蛊。", "六转元进度：蛊庐开放第 8 圃，不增加战力。", "七转元进度：蛊庐开放第 9 圃；入塔可携带 4 只随行蛊。", "八转元进度：蛊庐开放第 10 圃；蛊卵孵化时间缩短 20%。", "九转元进度：蛊庐开放第 11、12 圃；入塔可携带 5 只随行蛊，并得「九转」称号。"],
  },
  blood: {
    name: "赤茧蛊", glyph: "茧",
    lore: "血债结成的茧，茧里裹着没讨回来的旧仇。",
    stagePassives: ["尚在卵中沉睡。", "每场战斗开局自带 2 层血煞。", "血煞上限 +2。", "每局开局从「缝煞成茧 / 裂茧代偿」中选择一条互斥路线。", "血煞上限再 +2（累计 +4）。", "所选路线获得五转强化；入塔可携带 3 只随行蛊。", "六转元进度：蛊庐开放第 8 圃，不增加战力。", "七转元进度：蛊庐开放第 9 圃；入塔可携带 4 只随行蛊。", "八转元进度：蛊庐开放第 10 圃；蛊卵孵化时间缩短 20%。", "九转元进度：蛊庐开放第 11、12 圃；入塔可携带 5 只随行蛊，并得「九转」称号。"],
  },
  poison: {
    name: "蜕鳞蛊", glyph: "鳞",
    lore: "万毒噬身那夜蜕下的第一片鳞，还带着牙印。",
    stagePassives: ["尚在卵中沉睡。", "每场首次施毒额外 +1 层。", "攻击中毒的敌人时，伤害 +2。", "每局开局从「逆鳞后毒 / 蜕鳞借毒」中选择一条互斥路线。", "攻击中毒敌人的额外伤害再 +2（累计 +4）。", "所选路线获得五转强化；入塔可携带 3 只随行蛊。", "六转元进度：蛊庐开放第 8 圃，不增加战力。", "七转元进度：蛊庐开放第 9 圃；入塔可携带 4 只随行蛊。", "八转元进度：蛊庐开放第 10 圃；蛊卵孵化时间缩短 20%。", "九转元进度：蛊庐开放第 11、12 圃；入塔可携带 5 只随行蛊，并得「九转」称号。"],
  },
  longevity: {
    name: "灯芯蛊", glyph: "芯",
    lore: "半盏寿灯里没烧完的芯，一头连着朝，一头连着暮。",
    stagePassives: ["尚在卵中沉睡。", "寿元上限 +2。", "每局首次焚寿时，返还 1 点寿元。", "每局开局从「积薪成炬 / 朝暮回灯」中选择一条互斥路线。", "寿元上限再 +2（累计 +4）。", "所选路线获得五转强化；入塔可携带 3 只随行蛊。", "六转元进度：蛊庐开放第 8 圃，不增加战力。", "七转元进度：蛊庐开放第 9 圃；入塔可携带 4 只随行蛊。", "八转元进度：蛊庐开放第 10 圃；蛊卵孵化时间缩短 20%。", "九转元进度：蛊庐开放第 11、12 圃；入塔可携带 5 只随行蛊，并得「九转」称号。"],
  },
  dragon: {
    name: "烬脉龙蛊", glyph: "脉",
    lore: "末代墨裔从焦骨里剜出的活脉，七鳞合鸣时，仍记得真龙如何昂首。",
    stagePassives: ["尚在卵中沉睡。", "每场战斗开局获得 1 枚龙鳞。", "每场首次蓄满龙鳞时，获得 4 点防御。", "每局开局从「焚脉腾渊 / 玄甲镇脉」中选择一条互斥路线。", "开局龙鳞再 +1（累计 2 枚）。", "所选路线获得五转强化；入塔可携带 3 只随行蛊。", "六转元进度：蛊庐开放第 8 圃，不增加战力。", "七转元进度：蛊庐开放第 9 圃；入塔可携带 4 只随行蛊。", "八转元进度：蛊庐开放第 10 圃；蛊卵孵化时间缩短 20%。", "九转元进度：蛊庐开放第 11、12 圃；入塔可携带 5 只随行蛊，并得「九转」称号。"],
  },
  bone: {
    name: "叩寿骨铃", glyph: "叩",
    lore: "铃腔里没有铃舌，只有一只会替亡骨应声的活蛊。",
    stagePassives: ["尚在卵中沉睡。", "每场战斗开始时获得 1 点骨鸣。", "每场首次达到 3 点骨鸣时，获得 3 点防御。", "每局开局从「镇魂律 / 断命律」中选择一条互斥路线。", "开局骨鸣再 +1（累计 2 点）。", "所选路线获得五转强化；入塔可携带 3 只随行蛊。", "六转元进度：蛊庐开放第 8 圃，不增加战力。", "七转元进度：蛊庐开放第 9 圃；入塔可携带 4 只随行蛊。", "八转元进度：蛊庐开放第 10 圃；蛊卵孵化时间缩短 20%。", "九转元进度：蛊庐开放第 11、12 圃；入塔可携带 5 只随行蛊，并得「九转」称号。"],
  },
});
