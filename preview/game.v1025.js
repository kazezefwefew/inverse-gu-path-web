...
const GAME_VERSION = "V0.9.14 蛊修印录";
...
/* V0.9.14 蛊修印录：列传详情内的通关印记段（按英雄名反查 heroId，查不到则不渲染）。 */
function renderHeroSealSection(it) {
  ...
  return '<section class="wangulu-sec"><h4>通关印记</h4><div class="seal-chips seal-chips-detail">' + chips + '</div></section>';
}
