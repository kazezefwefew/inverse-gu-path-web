...
function cacheDom() {
  [
    ...
    "battleBackgroundSlot", "battleIntentRegion", "intentBox", "intentIcon", "intentName", "intentDescription", "intentSummary", "intentCollapseButton", "fateRewriteButton", "fateRewriteChoice", "mupanSealPanel", "enemyPower", "enemyStatusList", "arenaKicker",
    ...
    "hand", "battleActionBar", "selectedCardActions", "selectedCardName", "selectedCardDetailButton", "selectedCardPlayButton", "castDisplay", "castGlyph", "castName", "resultOverlay", "resultSeal",
...
function bindEvents() {
  ...
  dom.moreMenuButton?.addEventListener("click", (event) => {
    ...
    dom.moreMenuPanel?.classList.toggle("hidden", !opening);
    dom.moreMenuButton?.setAttribute("aria-expanded", String(opening));
  });
