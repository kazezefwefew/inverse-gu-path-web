...
window.GU_CATALOG = [
  ...
  /* ===== V0.9.8 第三层 · 首领残卷（category:"boss"，带 enemyId） ===== */
  {
    ...
    evolution: "半血触发「骨巢开裂」相位，召卫与蓄力压势大增。", synergy: "麾下尽是骨塔尸傀与骨甲蛊卫。", counteredBy: "惧持续压制；召卫蓄力须及时打断。",
  ...
  /* ===== V0.9.8 第三层 · 敌怪图谱（category:"enemy"，带 enemyId 供「已遇」解锁） ===== */
  {
    ...
    name: "骨铃蛊", alias: "乱铃扰神", rarity: "普通", faction: "护身", type: "敌怪", stage: "骨塔·杂蛊",
    descriptionShort: "背壳垂铃、摇铃乱神的骨塔杂蛊。",
    descriptionLore: "骨塔录：骨铃蛊背壳垂着一串森白骨铃，每一次摇动都在你耳中织出杂音。它不以力胜，专以乱铃扰你心神，趁你恍惚之际啄上一口。",
  ...
  },
  {
    ...
    name: "尸傀蛊兵", alias: "蓄力重击", rarity: "普通", faction: "护身", type: "敌怪", stage: "骨塔·列卒",
    descriptionShort: "残骨拼缀、蓄力重砸的骨塔列卒。",
    descriptionLore: "骨塔录：尸傀蛊兵由残骨与蛊丝拼缀成形，举起骨锤时关节咔咔作响。它动作迟缓却力大无穷，一旦蓄满力气，重砸下来便能裂石碎甲。",
    habitat: "列阵骨塔高陵的尸傀阵。", feeding: "由骨巢蛊丝牵引，无须进食。", temperament: "迟缓固执，蓄力则一击倾尽。",
    evolution: "（生态敌怪，暂无玩家蛊牌。）", synergy: "与骨甲蛊卫同列拦路。", counteredBy: "蓄力重砸受够阈值伤害可打断，未断则吃满一击。",
    dropsFrom: "第三层·骨塔高陵 普通战。", unlockCondition: "于骨塔遭遇即录入。",
    gameplayEffect: "缩骨蓄甲后蓄力重砸；蓄力可在受够阈值伤害后打断。", image: "",
  },
  {
    ...
    evolution: "（生态敌怪，暂无玩家蛊牌。）", synergy: "与尸傀蛊兵同列叠甲压迫。", counteredBy: "惧破甲与高爆；护甲未破前输出难以突破。",
    dropsFrom: "第三层·骨塔高陵 普通战。", unlockCondition: "于骨塔遭遇即录入。",
    gameplayEffect: "覆甲固身后，自身有护甲时攻击附加额外伤害（甲坚击重）。", image: "",
  },
  {
  ...
  /* ===== V0.9.8 第三层 · 生态条目（category:"eco"，沿用现有 eco 渲染，恒显示） ===== */
  {
    ...
    descriptionLore: "生态志·骨塔：命途更深处的第三层歧路之一，万骨堆叠成陵，骨铃幽响、尸傀列阵。此径之敌高护甲、善蓄力、能召卫，压力层层叠来——入此陵者须破甲打断，方能在被骨煞镇压之前杀上塔顶。",
