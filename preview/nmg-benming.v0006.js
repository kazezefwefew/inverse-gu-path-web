"use strict";
/* nmg-benming.js：V0.9.38 D-2c，本命蛊数据、道行、形态、路线（衔命虫/赤茧蛊/蜕鳞蛊）与立绘辅助。须在 game.v 之前加载。 */
...
const BENMING_PATH_SCHEMA = 3;
const BENMING_PATH_SCHEMA_MIN = Object.freeze({ blood: 2, poison: 3 });
...
function getBenmingStagePassiveText(heroId, stage, pathId = null, legacy = false) {
  ...
  if (!gu) return "";
  if (!(["fate", "blood", "poison"].includes(heroId)) || (stage !== 3 && stage !== 5)) return gu.stagePassives[stage] || "";
  if (legacy) {
