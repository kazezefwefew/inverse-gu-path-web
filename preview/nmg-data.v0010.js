...
const CARD_LIBRARY = {
  ...
  returnBreath: {
    ...
    glyph: "息", art: "命", effect: "抽 <em>2</em> 张牌",
  },
  hiddenMeridian: {
...
const CARD_UPGRADE_CONFIG = Object.freeze({
  ...
  returnBreath: { rule: "+1 抽牌 +1；+2 消耗降为 0" },
  ...
  borrowLife: { rule: "+1 抽牌 +1；+2 生命代价 -1" },
  ...
  cloudHorn: { rule: "+2 时额外获得 1 枚龙鳞；延长次数不变" },
...
const HEROES = {
  ...
  dragon: {
    ...
    passiveName: "逆鳞化龙",
    passive: "每回合首次以攻击蛊实际伤敌、首次以护甲蛊实际获得防御时，各得 1 枚龙鳞。满 6 鳞可主动龙化 2 回合：每回合真元 +1，攻击蛊伤害 +3，护甲蛊防御 +3。",
    caption: "骨藏逆鳞 · 一啸化龙",
