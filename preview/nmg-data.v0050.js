...
const CARD_LIBRARY = {
  ...
  moonBlade: {
    ...
    glyph: "月", art: "刃", effect: "对敌人造成 <em>7</em> 点伤害",
  },
  ironSkin: {
    name: "铁皮蛊", cost: 1, type: "defense", category: "defense", typeName: "防御蛊",
    glyph: "铁", art: "甲", effect: "获得 <em>8</em> 点防御",
  },
  wineWorm: {
  ...
  bloodBlade: {
    ...
    glyph: "血", art: "煞", effect: "失去 <em>3</em> 点生命，造成 <em>13 + 当前血煞</em> 点伤害，获得 <em>1</em> 层血煞；造成实伤后按血煞恢复生命，最多 <em>4</em> 点",
  },
  burningEssence: {
  ...
  tideRendingMantis: {
    name: "断潮螂", cost: 1, type: "blade", category: "attack", typeName: "蚀甲攻击蛊",
    glyph: "断", art: "螂", effect: "先移除敌人 <em>5</em> 点防御，再造成 <em>6</em> 点伤害；成功蚀甲时伤害 +<em>3</em>",
  },
  pulseReturningSilkworm: {
    name: "归脉蚕", cost: 1, type: "yuan", category: "utility", typeName: "回生辅助蛊",
    glyph: "归", art: "蚕", effect: "生命不高于一半时恢复 <em>3</em> 点生命，否则获得 <em>5</em> 点防御",
  },
  sequenceCicada: {
    name: "换序蝉", cost: 1, type: "yuan", category: "utility", typeName: "换序辅助蛊",
    glyph: "序", art: "蝉", effect: "抽 <em>1</em> 张牌；若与上一张牌类别不同，获得 <em>3</em> 点防御",
  },
  boneStingBee: {
    name: "蜇骨蜂", cost: 1, type: "blade", category: "attack", typeName: "衰势攻击蛊",
    glyph: "蜇", art: "蜂", effect: "造成 <em>7</em> 点伤害；敌人已有衰老时伤害 +<em>4</em>",
  },
  venomLurkingSpider: {
    name: "伏毒蛛", cost: 1, type: "poison", category: "defense", typeName: "毒势防御蛊",
    glyph: "伏", art: "蛛", effect: "获得 <em>7</em> 点防御；敌人已有毒性时再获得 <em>3</em> 点",
  },
  redTideGu: {
  ...
  // V0.9.80 万蛊游园珍稀蛊：只从奇茧独立卡池取得，不混入普通奖励与开局择蛊。
  hiddenGlowGourd: {
    name: "藏晖瓢", cost: 1, type: "blade", category: "attack", typeName: "珍稀·蓄势攻击蛊",
    glyph: "晖", art: "瓢", parkRare: true, effect: "造成 <em>7</em> 点伤害；回合结束可封存至多 <em>1</em> 点余元，下回合首张攻击追加伤害并等量少恢复真元",
  },
  burdenLampSnail: {
    name: "负灯蜗", cost: 1, type: "shell", category: "defense", typeName: "珍稀·负债防御蛊",
    glyph: "负", art: "蜗", parkRare: true, effect: "获得 <em>12</em> 点防御并背负护甲债；下一张防御蛊清债后返还防御",
  },
  borrowTideSilkworm: {
    name: "借潮蚕", cost: 0, type: "yuan", category: "utility", typeName: "珍稀·换拍辅助蛊",
    glyph: "借", art: "蚕", parkRare: true, effect: "每回合限一次：抽牌并获得防御；高转抽二弃一、下一张非零费蛊减费，下回合少恢复 <em>1</em> 点真元",
  },
  bloodMiasmaMediator: {
    name: "血瘴媒", cost: 1, type: "poison", category: "attack", typeName: "珍稀·毒血桥接蛊",
    glyph: "媒", art: "瘴", parkRare: true, effect: "移除敌人至多 <em>2</em> 层毒性，每层造成 <em>3</em> 点伤害；移满时以生命换血煞与防御",
  },
  fateMeasureInchworm: {
    name: "量命尺蠖", cost: 1, type: "fate", category: "utility", typeName: "珍稀·命势编排蛊",
    glyph: "量", art: "蠖", parkRare: true, effect: "本场一次：3 回合内各催动攻击、防御、辅助蛊后，扩展下一次命势改签候选并获得防御",
  },
  returnCasketMayfly: {
    name: "归箧蜉蝣", cost: 1, type: "utility", category: "utility", typeName: "珍稀·牌序回收蛊",
    glyph: "箧", art: "蝣", parkRare: true, effect: "本场最多两次：从近期合格弃牌中取回 1 张；本蛊沉眠，取回牌不可再触发弃牌回收",
  },
  riftMantis: {
    name: "裂隙螳", cost: 1, type: "blade", category: "attack", typeName: "珍稀·三式追击蛊",
    glyph: "隙", art: "螳", parkRare: true, effect: "造成 <em>8</em> 点伤害；本回合此前每走过一种蛊术类别，再追加有限伤害",
  },
  debtEatingAnt: {
    name: "食债蚁", cost: 1, type: "shell", category: "defense", typeName: "珍稀·吞债防御蛊",
    glyph: "债", art: "蚁", parkRare: true, effect: "每回合限一次：获得防御，并吞下一笔真元债或护甲债；有债时追加防御",
  },
  emberCasketFirefly: {
    name: "烬箧萤", cost: 1, type: "blade", category: "attack", typeName: "珍稀·化灰终式蛊",
    glyph: "烬", art: "萤", parkRare: true, exhaust: true, effect: "本场一次：按化灰区内有限蛊牌造成伤害并获得防御；催动后沉眠",
  },
  ashBreathMayfly: {
  ...
  redTideBladeLeech: {
    name: "赤汐刃蛭", cost: 1, type: "blood", category: "attack", typeName: "耗煞生煞合练蛊",
  ...
  moltingShell: {
    ...
    glyph: "蜕", art: "壳", effect: "获得 <em>8</em> 点防御；敌人每 <em>2</em> 层毒额外获得 1 点防御（最多 <em>6</em> 点）；若敌人已中毒，抽 <em>1</em> 张牌",
  },
  poisonReturn: {
  ...
  bloodMoon: {
    ...
    glyph: "月", art: "血", effect: "失去 <em>2</em> 点生命，造成 <em>12</em> 点伤害并追加当前血煞；获得 <em>1</em> 层血煞，造成实伤后按旧血煞恢复 <em>1～4</em> 点生命",
  },
  moltedArmor: {
  ...
  drunkFateWorm: {
    ...
    glyph: "醉", art: "酒", effect: "叠 1 层酒意（最多 3 层，伤害 <em>×2 / ×2.5 / ×3</em>）；若本回合尚未获得命势，获得 <em>1</em> 层命势，否则抽 <em>1</em> 张牌",
  },
  soulBurn: {
  ...
  bloodSwarmBlade: {
    ...
    glyph: "群", art: "刃", effect: "失去 <em>3</em> 点生命，造成 <em>9 + 当前血煞 + 此前出牌×2</em> 点伤害（最多计 <em>3</em> 张），获得 <em>1</em> 层血煞；命中后按旧血煞恢复生命",
  },
  borrowedBloodRobe: {
  ...
  venomMoltCarapace: {
    ...
    glyph: "毒", art: "蜕", effect: "获得 <em>10</em> 点防御，并按敌人毒性追加防御（最多 <em>6</em>）；若敌人已中毒，抽 <em>1</em> 张牌，三转起抽 <em>2</em> 张",
  },
...
const V0984_COMMON_CARD_KEYS = Object.freeze([
  "tideRendingMantis", "pulseReturningSilkworm", "sequenceCicada", "boneStingBee", "venomLurkingSpider",
]);

const PARK_RARE_GU_KEYS = Object.freeze([
  "hiddenGlowGourd", "burdenLampSnail", "borrowTideSilkworm",
  "bloodMiasmaMediator", "fateMeasureInchworm", "returnCasketMayfly",
  "riftMantis", "debtEatingAnt", "emberCasketFirefly",
]);
...
const STANDARD_REWARD_CARD_KEYS = Object.freeze([
  ...
  ...V0959_COMMON_CARD_KEYS,
  ...ECOLOGY_BATCH_TWO_CARD_KEYS,
  ...V0984_COMMON_CARD_KEYS,
].filter((key, index, all) => all.indexOf(key) === index));

const STARTER_GU_DEFAULT_KEYS = Object.freeze(["moonBlade", "ironSkin"]);
const STARTER_GU_OPEN_COHORT_KEYS = Object.freeze([
  "moonBlade", "ironSkin", "wineWorm", "bloodBlade", "burningEssence",
  "armorBreaker", "yuanReturn", "shellRemnant", "guFeeding", "armorMeltPoison", "bloodRobe", "lifeLamp",
  "returnBreath", "hiddenMeridian", "thunderGuide", "apertureGuard", "emberRemnant", "shadowBind", "borrowLife",
  "jadeFang", "hollowNeedle", "coiledShell", "mirrorCarapace", "breathCicada", "yuanVessel", "rustMite", "silenceMoth",
  "longBreathGu", "chainThunderGu", "calamityAshGu",
]);
...
const ECOLOGY_MATERIALS = Object.freeze({
  miasmaMossSac: { name: "瘴苔囊", glyph: "瘴", tone: "poison", image: "assets/codex/materials/miasma-moss-sac.webp", short: "瘴林活苔结成的育蛊囊。" },
  bloodMarshMarrow: { name: "血沼髓", glyph: "沼", tone: "blood", image: "assets/codex/materials/blood-marsh-marrow.webp", short: "血沼沉积的温热虫髓。" },
  weatheredBoneSalt: { name: "风化骨盐", glyph: "盐", tone: "bone", image: "assets/codex/materials/weathered-bone-salt.webp", short: "骨原风蚀后析出的白盐。" },
  mysticHiveWax: { name: "玄巢蜡", glyph: "蜡", tone: "gold", image: "assets/codex/materials/mystic-hive-wax.webp", short: "玄巢工虫封存雷息的巢蜡。" },
});
...
const CARD_UPGRADE_CONFIG = Object.freeze({
  ...
  bloodBlade: { rule: "基础伤害每级 +4，保留 3 点生命反噬与按血煞封顶回血" },
  ...
  thunderGuide: { rule: "二转基础伤害 +3；三转连携伤害 +2；三转后每转基础伤害 +3" },
  ...
  moltingShell: { rule: "每级基础防御 +4；毒转甲封顶不变；+2 时中毒抽牌 +1" },
  ...
  bloodMoon: { rule: "异变血道攻击：+2 时基础伤害 +4；血煞额外伤害、生煞与封顶回血保留" },
  ...
  drunkFateWorm: { rule: "异变辅助：无命势时获得 1 层命势；+1 时已有命势的抽牌改为 2 张" },
  ...
  bloodSwarmBlade: { rule: "每转基础伤害 +4；此前出牌追加与计数上限继承群蛊噬曲线，封顶回血、生煞与生命代价固定" },
  ...
  venomMoltCarapace: { rule: "每转防御 +4；毒转甲封顶不变，三转起敌人已中毒时抽 2 张" },
...
const PORTRAIT_PATHS = Object.freeze({
  heroes: {
    fate: "assets/portraits/duel/hero-fate-clean.v3.webp",
    blood: "assets/portraits/duel/hero-blood-duel.webp",
    poison: "assets/portraits/duel/hero-poison-duel.webp",
    longevity: "assets/portraits/duel/hero-longevity-duel.webp",
    dragon: "assets/portraits/duel/hero-dragon-duel.webp",
    dragonTransformed: "assets/portraits/duel/hero-dragon-duel.webp",
  ...
  enemies: {
    ...
    buriedBoneMoth: "assets/portraits/endless-buried-bone-moth.webp",
    burialScaleLizard: "assets/portraits/endless-burial-scale-lizard.webp",
    stitchBoneApe: "assets/portraits/endless-stitch-bone-ape.webp",
    thousandJointBoneMother: "assets/portraits/endless-thousand-joint-bone-mother.webp",
    burdenTowerTurtle: "assets/portraits/endless-burden-tower-turtle.webp",
    returningTideMushroom: "assets/portraits/endless-returning-tide-mushroom.webp",
    poisonDrinkingTick: "assets/portraits/endless-poison-drinking-tick.webp",
    mistLungFrog: "assets/portraits/endless-mist-lung-frog.webp",
    marshLampMoth: "assets/portraits/endless-marsh-lamp-moth.webp",
    rotTideMirageMother: "assets/portraits/endless-rot-tide-mirage-mother.webp",
    lotSwallowingSpider: "assets/portraits/endless-lot-swallowing-spider.webp",
    marrowBurningHound: "assets/portraits/endless-marrow-burning-hound.webp",
    mirrorFateSilkworm: "assets/portraits/endless-mirror-fate-silkworm.webp",
    myriadEyeCovenantBeast: "assets/portraits/endless-myriad-eye-covenant-beast.webp",
    reverseBornTowerFetus: "assets/portraits/endless-reverse-born-tower-fetus.webp",
  ...
  relics: {
    ...
    tailCutCharm: "assets/relics/generated/tail-cut-charm.webp",
    bloodJadeCup: "assets/relics/generated/blood-jade-cup.webp",
    greenPouchBug: "assets/relics/generated/green-pouch-bug.webp",
    fateCoin: "assets/relics/generated/fate-coin.webp",
    shopContract: "assets/relics/generated/shop-contract.webp",
    furnaceAshSeal: "assets/relics/generated/furnace-ash-seal.webp",
    venomFang: "assets/relics/generated/venom-fang.webp",
    chainFate: "assets/relics/generated/chain-fate.webp",
    fateSurge: "assets/relics/generated/fate-surge.webp",
    fateBurst: "assets/relics/generated/fate-burst.webp",
    fateRemnant: "assets/relics/generated/fate-remnant.webp",
    bloodAbyss: "assets/relics/generated/blood-abyss.webp",
    bloodPrimer: "assets/relics/generated/blood-primer.webp",
    bloodRepay: "assets/relics/generated/blood-repay.webp",
    bloodEcho: "assets/relics/generated/blood-echo.webp",
    thickVenom: "assets/relics/generated/thick-venom.webp",
    boneVenom: "assets/relics/generated/bone-venom.webp",
    venomLead: "assets/relics/generated/venom-lead.webp",
    burnDraw: "assets/relics/generated/burn-draw.webp",
    soulBurnMirror: "assets/relics/generated/soul-burn-mirror.webp",
    lifeKindle: "assets/relics/generated/life-kindle.webp",
    desperatePact: "assets/relics/generated/desperate-pact.webp",
    loneValor: "assets/relics/generated/lone-valor.webp",
    stoneInterest: "assets/relics/generated/stone-interest.webp",
    ironGallSeal: "assets/relics/generated/iron-gall-seal.webp",
    fateLoom: "assets/relics/generated/fate-loom.webp",
    bloodBrandSeal: "assets/relics/generated/blood-brand-seal.webp",
    venomHeartPearl: "assets/relics/generated/venom-heart-pearl.webp",
    emberRobe: "assets/relics/generated/ember-robe.webp",
    duskLamp: "assets/relics/generated/dusk-lamp.webp",
    scaleForge: "assets/relics/generated/scale-forge.webp",
    dragonFury: "assets/relics/generated/dragon-fury.webp",
    dragonHide: "assets/relics/generated/dragon-hide.webp",
    dragonBloodAmber: "assets/relics/generated/dragon-blood-amber.webp",
    whetstoneShard: "assets/relics/generated/whetstone-shard.webp",
    hollowGourd: "assets/relics/generated/hollow-gourd.webp",
    mendingThread: "assets/relics/generated/mending-thread.webp",
    cinderPouch: "assets/relics/generated/cinder-pouch.webp",
    scaleDustSac: "assets/relics/generated/scale-dust-sac.webp",
    dragonPulseCore: "assets/relics/generated/dragon-pulse-core.webp",
    ashLantern: "assets/relics/generated/ash-lantern.webp",
    weaveKnot: "assets/relics/generated/weave-knot.webp",
  ...
  battleItems: {
    huihunDan: "assets/items/battle/huihun-dan.webp",
    huxinJia: "assets/items/battle/huxin-jia.webp",
    yinluChong: "assets/items/battle/yinlu-chong.webp",
    ningyuanSha: "assets/items/battle/ningyuan-sha.webp",
    ningshaPo: "assets/items/battle/ningsha-po.webp",
    chixueLu: "assets/items/battle/chixue-lu.webp",
    baoduNang: "assets/items/battle/baodu-nang.webp",
    qingzhangSan: "assets/items/battle/qingzhang-san.webp",
    yinshiLing: "assets/items/battle/yinshi-ling.webp",
    dingpanZhu: "assets/items/battle/dingpan-zhu.webp",
    zhuyanLu: "assets/items/battle/zhuyan-lu.webp",
    suijinXiang: "assets/items/battle/suijin-xiang.webp",
  },
  enemyIntents: {
    attack: "assets/icons/enemy-intents/attack.webp",
    defend: "assets/icons/enemy-intents/defend.webp",
    charge: "assets/icons/enemy-intents/charge.webp",
    poisonSwallow: "assets/icons/enemy-intents/poison-swallow.webp",
  },
});
...
const ENEMY_LIBRARY = {
  ...
  stoneGuFalcon: {
    ...
    mechanicProfile: "dive_lock", mechanicHandler: "interrupt", mechanicIdentity: "俯冲锁喉", mechanicCounter: "以伤断其俯冲", mechanicCounterEffect: "clear_charge",
    kicker: "翅影掠阶，缝线未松",
  ...
  steleGolem: {
    ...
    mechanicProfile: "stele_guard_charge", mechanicHandler: "armor_gate", mechanicIdentity: "碑甲蓄压", mechanicCounter: "击碎碑甲", mechanicCounterEffect: "weaken_next_attack",
    kicker: "碑片相擦，祭文剥落",
  ...
  vineCrone: {
    ...
    mechanicProfile: "vine_bind", mechanicHandler: "mark_then_strike", mechanicIdentity: "藤铃缚身", mechanicCounter: "无伤挡下缚击", mechanicCounterEffect: "weaken_next_attack",
    kicker: "铃声不响，藤根先动",
  ...
  shadowHound: {
    ...
    mechanicProfile: "shadow_lifesteal", mechanicHandler: "lifesteal_block", mechanicIdentity: "啖影回血", mechanicCounter: "护甲挡尽噬血", mechanicCounterEffect: "weaken_next_attack",
    kicker: "四足无声，影中有脸",
  ...
  miasmaToad: {
    ...
    mechanicProfile: "swelling_poison", mechanicHandler: "burst_window", mechanicIdentity: "鼓腹瘴囊", mechanicCounter: "趁鼓腹重创", mechanicCounterEffect: "clear_charge",
    ecologyTags: ["decay"],
    kicker: "腹鼓一声，黄绿雾起",
  ...
  splitSkullMonk: {
    ...
    mechanicProfile: "prayer_bloom", mechanicHandler: "stack_growth", mechanicIdentity: "伪祷瘴华", mechanicCounter: "开花前打散瘴息", mechanicCounterEffect: "clear_stacks",
  ...
  bloodEelMother: {
    ...
    mechanicProfile: "eel_lifesteal_charge", mechanicHandler: "lifesteal_block", mechanicIdentity: "血鳗回涌", mechanicCounter: "护甲挡尽噬血", mechanicCounterEffect: "weaken_next_attack",
  ...
  sunkenPuppeteer: {
    ...
    mechanicProfile: "puppet_strings", mechanicHandler: "mark_then_strike", mechanicIdentity: "尸线牵命", mechanicCounter: "无伤挡下牵击", mechanicCounterEffect: "weaken_next_attack",
    ecologyTags: ["corpse"],
    kicker: "红线绷紧，浮尸抬手",
  ...
  boneBellGuard: {
    ...
    mechanicProfile: "bell_armor_charge", mechanicHandler: "armor_gate", mechanicIdentity: "钟甲蓄震", mechanicCounter: "击碎钟甲", mechanicCounterEffect: "weaken_next_attack",
    kicker: "钟舌一荡，骨塔皆震",
  ...
  steleLeech: {
    ...
    mechanicProfile: "armor_drill", mechanicHandler: "interrupt", mechanicIdentity: "钻劲蚀防", mechanicCounter: "以伤断其钻劲", mechanicCounterEffect: "clear_charge",
    kicker: "石屑纷落，螺沟在延",
  ...
  waxAttendant: {
    ...
    mechanicProfile: "wax_reseal", mechanicHandler: "burst_window", mechanicIdentity: "蜡壳重封", mechanicCounter: "趁重封重创", mechanicCounterEffect: "clear_armor",
    kicker: "蜡壳皲裂，又自合拢",
  ...
  honeyWomb: {
    ...
    mechanicProfile: "hive_gestation", mechanicHandler: "stack_growth", mechanicIdentity: "巢囊孕蛊", mechanicCounter: "孵化前打散幼蛊", mechanicCounterEffect: "clear_stacks",
    kicker: "囊壁搏动，金红滴落",
  ...
  shanxiao: {
    ...
    title: "塔中凶兽",
    maxHp: 48,
    mechanicProfile: "shanxiao_interrupt",
    mechanicHandler: "interrupt", mechanicIdentity: "裂石蓄势", mechanicCounter: "以伤打断蓄势", mechanicCounterEffect: "clear_charge",
    kicker: "阴风穿塔，兽啸逼近",
    ...
    actions: {
      ...
      charge: { name: "蓄势", icon: "势", kind: "charge", bonus: 5, interruptThreshold: 8 },
    },
  },
  rottenShanxiao: {
    name: "腐皮山魈",
    title: "腐毒凶兽",
    maxHp: 54,
    mechanicProfile: "rot_poison_burst", mechanicHandler: "burst_window", mechanicIdentity: "腐息毒囊", mechanicCounter: "蓄毒时重创", mechanicCounterEffect: "clear_charge",
    kicker: "腐皮剥落，腥毒渗阶",
  ...
  bloodwolf: {
    ...
    title: "血沼凶兽",
    maxHp: 52,
    mechanicProfile: "hunt_unarmored", mechanicHandler: "mark_then_strike", mechanicIdentity: "血爪猎隙", mechanicCounter: "无伤挡下扑咬", mechanicCounterEffect: "weaken_next_attack",
    kicker: "血雾贴地，狼嚎裂心",
  ...
  redManeBloodwolf: {
    ...
    title: "赤鬃凶兽",
    maxHp: 50,
    mechanicProfile: "mane_enrage", mechanicHandler: "enrage_window", mechanicIdentity: "赤鬃狂怒", mechanicCounter: "狂怒初起时重创", mechanicCounterEffect: "weaken_next_attack",
    kicker: "赤鬃燃血，狼影贴地",
  ...
  bloodwolfElite: {
    ...
    maxHp: 76,
    isElite: true,
    mechanicProfile: "wolf_armor_execute", mechanicHandler: "armor_gate", mechanicIdentity: "血纹护甲", mechanicCounter: "击碎血纹护甲", mechanicCounterEffect: "clear_armor",
    kicker: "血纹伏地，狼王拦路",
  ...
  beeswarm: {
    ...
    title: "失控虫群",
    maxHp: 44,
    mechanicProfile: "swarm_unblocked_poison", mechanicHandler: "mark_then_strike", mechanicIdentity: "蜂群毒刺", mechanicCounter: "无伤挡下蜂刺", mechanicCounterEffect: "weaken_next_attack",
    kicker: "毒翅蔽灯，群蜂如潮",
  ...
  wildBeeTide: {
    ...
    title: "暴乱虫群",
    maxHp: 46,
    mechanicProfile: "swarm_density", mechanicHandler: "stack_growth", mechanicIdentity: "蜂潮密度", mechanicCounter: "聚形后迅速打散", mechanicCounterEffect: "clear_stacks",
    kicker: "乱翅撞灯，蜂潮翻涌",
  ...
  corpsepuppet: {
    ...
    maxHp: 108,
    isBoss: true,
    mechanicProfile: "corpse_disk_phases", mechanicHandler: "corpse_disk_phase", mechanicIdentity: "尸盘转轮", mechanicCounter: "转轮初起时重创", mechanicCounterEffect: "weaken_next_attack",
...
/* ---- 瘴林路线（毒/持续伤害/削弱） ---- */
  rotleafGu: {
    ...
    pressurePrimary: "poison",
    mechanicProfile: "poison_pressure", mechanicHandler: "mark_then_strike", mechanicIdentity: "腐叶毒压", mechanicCounter: "无伤挡下毒啃", mechanicCounterEffect: "weaken_next_attack",
    kicker: "腐叶簌簌，毒涎滴阶",
  ...
  miasmaParasite: {
    name: "青瘴寄生", title: "附骨之瘴", maxHp: 60, mechanicProfile: "miasma_convert", poisonConvert: { threshold: 8, give: 3, cap: 6, cooldown: 2 },
    mechanicHandler: "trigger_window", mechanicTrigger: "poison_converted", mechanicIdentity: "瘴毒反施", mechanicCounter: "吐毒后立刻重创", mechanicCounterEffect: "weaken_next_attack",
    pressurePrimary: "poison",
    kicker: "青瘴附骨，越缠越深",
  ...
  poisonVineCorpse: {
    ...
    mechanicProfile: "armor_purge_poison", mechanicHandler: "trigger_window", mechanicTrigger: "block_purged", mechanicIdentity: "凝甲蚀毒", mechanicCounter: "凝甲后立刻重创", mechanicCounterEffect: "weaken_next_attack",
    pressurePrimary: "poison", pressureSecondary: ["armor"], pressureSecondaryEffects: { armor: ["armor", "armorCap"] }, mechanicRequiredActionFields: ["armor"],
    kicker: "毒藤穿尸，腐手拖泥",
  ...
  miasmaLanternEliteGu: {
    ...
    mechanicProfile: "lantern_mark", mechanicHandler: "mark_then_strike", mechanicIdentity: "鬼灯牵瘴", mechanicCounter: "无伤挡下引瘴", mechanicCounterEffect: "weaken_next_attack",
    pressurePrimary: "poison", pressureSecondary: ["armor"], pressureSecondaryEffects: { armor: ["armor", "armorCap"] },
    kicker: "鬼灯引瘴，林深无路",
  ...
  miasmaMotherBoss: {
    ...
    mechanicProfile: "mother_swallow_phase", mechanicHandler: "boss_phase_window", mechanicIdentity: "瘴母苏醒", mechanicCounter: "苏醒之际重创", mechanicCounterEffect: "weaken_next_attack", mechanicWarning: "百瘴母蛊腹囊鼓胀，瘴母苏醒将至。", pressurePrimary: "poison", pressureSecondary: ["armor"], pressureSecondaryEffects: { armor: ["armor", "armorCap"] },
    ecologyTags: ["decay"],
    kicker: "百瘴归巢，林木尽腐",
...
/* ---- 血沼路线（血道/自损/吸血/反噬） ---- */
  bloodLeechSwarm: {
    ...
    pressurePrimary: "blood", pressureSecondary: ["lifesteal"], pressureSecondaryEffects: { lifesteal: ["lifesteal"] }, mechanicRequiredActionFields: ["lifesteal"],
    mechanicProfile: "leech_block", mechanicHandler: "lifesteal_block", mechanicIdentity: "群蛭吸髓", mechanicCounter: "护甲挡尽吸血", mechanicCounterEffect: "weaken_next_attack",
    kicker: "蛭群附身，吸血而肥",
  ...
  brokenMeridianGu: {
    name: "断脉蛊徒", title: "自戕血修", maxHp: 60, mechanicProfile: "broken_meridian_gap",
    mechanicHandler: "trigger_window", mechanicTrigger: "blood_gap_armed", mechanicIdentity: "断脉血隙", mechanicCounter: "血隙初开时重创", mechanicCounterEffect: "weaken_next_attack",
    pressurePrimary: "blood", pressureSecondary: ["lifesteal"], pressureSecondaryEffects: { lifesteal: ["lifesteal"] },
    kicker: "自断经脉，以血换力",
  ...
  bloodMudGolem: {
    name: "血泥傀", title: "沼底血傀", maxHp: 66, mechanicProfile: "blood_mud_lifesteal",
    mechanicHandler: "lifesteal_block", mechanicIdentity: "血泥回涌", mechanicCounter: "护甲挡尽回血", mechanicCounterEffect: "weaken_next_attack",
    pressurePrimary: "blood", pressureSecondary: ["lifesteal"], pressureSecondaryEffects: { lifesteal: ["lifesteal"] }, mechanicRequiredActionFields: ["lifesteal"],
    kicker: "血泥成傀，越打越凝",
  ...
  bloodRobePriestEliteGu: {
    ...
    mechanicProfile: "blood_robe_cycle", mechanicHandler: "trigger_window", mechanicTrigger: "self_bleed", mechanicIdentity: "血祭回环", mechanicCounter: "自损后立刻重创", mechanicCounterEffect: "weaken_next_attack",
    pressurePrimary: "blood", pressureSecondary: ["lifesteal"], pressureSecondaryEffects: { lifesteal: ["lifesteal"] },
    kicker: "血衣加身，以命饲蛊",
  ...
  bloodRobeMotherBoss: {
    ...
    mechanicProfile: "blood_debt_phase", mechanicHandler: "boss_phase_window", mechanicIdentity: "血衣覆身", mechanicCounter: "覆身之际重创", mechanicCounterEffect: "weaken_next_attack", mechanicWarning: "血衣蛊母的血袍翻涌，覆身异相将至。", pressurePrimary: "blood", pressureSecondary: ["lifesteal"], pressureSecondaryEffects: { lifesteal: ["lifesteal"] },
    ecologyTags: ["bloodFeeder"],
    kicker: "血衣覆世，血债同偿",
...
/* ---- 骨塔高陵路线（护甲/蓄力打断/召卫/执令） ---- */
  bonebellGu: {
    ...
    mechanicProfile: "bell_draw_armor", mechanicHandler: "armor_gate", mechanicIdentity: "骨铃覆甲", mechanicCounter: "击碎骨铃护甲", mechanicCounterEffect: "clear_armor",
  ...
  skeletonPuppetGu: {
    name: "朽甲蛊兵", title: "骨塔列卒", maxHp: 62, poisonResist: 0.3, mechanicProfile: "bone_break_interrupt", mechanicHandler: "interrupt", mechanicIdentity: "蓄力骨锤", mechanicCounter: "以伤打断骨锤", mechanicCounterEffect: "clear_charge",
  ...
  boneArmorGuardGu: {
    ...
    mechanicProfile: "armor_damage", mechanicHandler: "armor_gate", mechanicIdentity: "骨甲加重", mechanicCounter: "击碎骨甲压低重击", mechanicCounterEffect: "clear_armor",
    ecologyTags: ["armor"],
    kicker: "骨甲覆身，有甲愈凶",
  ...
  boneCommanderElite: {
    ...
    mechanicProfile: "command_mark", mechanicHandler: "trigger_window", mechanicTrigger: "commander_marked", mechanicIdentity: "执令印记", mechanicCounter: "印记亮起时重创断令", mechanicCounterEffect: "clear_command",
  ...
  boneNestGuardianBoss: {
    ...
    mechanicProfile: "bone_nest_phase", mechanicHandler: "boss_phase_window", mechanicIdentity: "骨巢开裂", mechanicCounter: "异相转动时重创", mechanicCounterEffect: "weaken_next_attack", mechanicWarning: "骨巢裂缝正在扩开，下一击尚可被压制。",
    ecologyTags: ["armor", "corpse"],
    kicker: "骨巢镇陵，守墓不退",
...
/* ---- 蜂窟魔巢路线（毒刺/蜂群/抢攻/多段） ---- */
  venomBeeGu: {
    ...
    mechanicProfile: "venom_multihit", mechanicHandler: "mark_then_strike", mechanicIdentity: "毒针连刺", mechanicCounter: "无伤挡下连刺", mechanicCounterEffect: "weaken_next_attack",
    kicker: "毒蜂乱舞，针针带毒",
  ...
  beehiveBroodGu: {
    ...
    mechanicProfile: "swarm_growth", mechanicHandler: "stack_growth", mechanicIdentity: "蜂群孵化", mechanicCounter: "蜂群增殖后立刻打散", mechanicCounterEffect: "clear_stacks",
    kicker: "蜂巢孵潮，越拖越凶",
  ...
  chaosSwarmHordeGu: {
    name: "蜂潮蛊涌", title: "蜂窟潮群", maxHp: 56, mechanicProfile: "swarm_counter", mechanicHandler: "trigger_window", mechanicTrigger: "swarm_counter_window", mechanicIdentity: "蜂潮抢攻", mechanicCounter: "密牌预警时重创压潮", mechanicCounterEffect: "clear_counter",
    kicker: "蜂潮翻涌，密则反噬",
  ...
  beehiveGuardElite: {
    ...
    mechanicProfile: "guard_counter_armor", mechanicHandler: "trigger_window", mechanicTrigger: "swarm_counter_window", mechanicIdentity: "蜡甲抢攻", mechanicCounter: "抢攻预警时重创断刺", mechanicCounterEffect: "clear_counter",
    kicker: "守卫巡巢，触之即刺",
  ...
  calamityQueenBoss: {
    ...
    mechanicProfile: "queen_swarm_phase", mechanicHandler: "boss_phase_window", mechanicIdentity: "蜂群暴动", mechanicCounter: "暴动初起时重创", mechanicCounterEffect: "weaken_next_attack", mechanicWarning: "蜂后振翅聚群，暴动的下一击仍可被压制。",
    kicker: "蜂后临巢，万翅同振",
  ...
  /* ===== V0.9.75 无尽异相生态：仅在无尽20层后进入敌人池。 ===== */
  buriedBoneMoth: {
    name: "伏骸螟", title: "骨殖井寄甲", maxHp: 58,
    mechanicProfile: "buried_bone_charge", mechanicHandler: "armor_gate", mechanicIdentity: "寄骨蓄击", mechanicCounter: "两回合内击碎寄骨甲", mechanicCounterEffect: "clear_charge",
    endlessPattern: "boneCharge", ecologyTags: ["armor", "corpse"], lessonKey: "break_buried_armor", historyKey: "endless_buried_bone_moth",
    kicker: "伏在骸下，借骨成锋", intro: "伏骸螟钻在断骨之间，正把寄骨甲压成下一击的锋刃。", caption: "寄骨未碎 · 蓄击愈沉",
    actions: {
      gnaw: { name: "啮骨", icon: "啮", kind: "attack", damage: 8 },
      graftArmor: { name: "寄骨覆甲", icon: "骨", kind: "charge", bonus: 4, armor: 9, armorCap: 18, interruptThreshold: 10 },
      boneBurst: { name: "骸甲迸击", icon: "迸", kind: "attack", damage: 7, consumeOwnArmorDamage: 0.5 },
    },
  },
  burialScaleLizard: {
    name: "葬鳞蜥", title: "骨殖井试鳞", maxHp: 64,
    mechanicProfile: "burial_scale", mechanicHandler: "trigger_window", mechanicTrigger: "first_hit_spent", mechanicIdentity: "葬鳞试锋", mechanicCounter: "先以轻击试鳞", mechanicCounterEffect: "weaken_next_attack",
    endlessPattern: "firstHitScale", ecologyTags: ["armor"], lessonKey: "probe_first_scale", historyKey: "endless_burial_scale_lizard", def: { firstHitReduction: 0.5 },
    kicker: "首鳞藏刃，次击见肉", intro: "葬鳞蜥把最厚的一片旧鳞朝向你，等着吞下本回合第一击。", caption: "首击减伤 · 后续如常",
    actions: {
      scaleBite: { name: "鳞吻", icon: "吻", kind: "attack", damage: 9 },
      tailSweep: { name: "葬尾横扫", icon: "扫", kind: "attack", damage: 5, hits: 2 },
      curl: { name: "卷鳞", icon: "卷", kind: "defend", block: 7, armorCap: 14 },
    },
  },
  stitchBoneApe: {
    name: "缝骨猿", title: "骨殖井缝尸", maxHp: 70,
    mechanicProfile: "stitch_guard", mechanicHandler: "armor_gate", mechanicIdentity: "缝骨续伤", mechanicCounter: "防守回合击碎其甲", mechanicCounterEffect: "clear_armor",
    endlessPattern: "stitchHeal", ecologyTags: ["armor", "corpse"], lessonKey: "break_stitch_guard", historyKey: "endless_stitch_bone_ape",
    kicker: "骨线牵肉，甲存则愈", intro: "缝骨猿用骨线把裂开的皮肉缝回去，护甲若未破便会完成续伤。", caption: "守甲续伤 · 破甲止愈",
    actions: {
      boneFist: { name: "缝骨拳", icon: "拳", kind: "attack", damage: 10 },
      stitchGuard: { name: "缝伤护骨", icon: "缝", kind: "defend", block: 10, armorCap: 18, healIfArmorHeld: 7 },
      hookLine: { name: "骨线拖拽", icon: "线", kind: "attack", damage: 7, applyVulnerable: 1 },
    },
  },
  thousandJointBoneMother: {
    name: "千节骨母", title: "骨殖井精英", maxHp: 108, isElite: true,
    mechanicProfile: "three_bone_sections", mechanicHandler: "trigger_window", mechanicTrigger: "bone_section_broken", mechanicIdentity: "三节外骨", mechanicCounter: "以攻击、施毒或破甲拆节", mechanicCounterEffect: "weaken_next_attack",
    endlessPattern: "threeSections", ecologyTags: ["armor", "corpse"], lessonKey: "break_bone_section", historyKey: "endless_thousand_joint_bone_mother", def: { boneArmorStart: 14, boneArmorRegen: 3, boneArmorCap: 20 },
    kicker: "千节相扣，拆一缓一", intro: "千节骨母背负三段外骨，分别惧怕直击、毒蚀与破甲。", caption: "三节外骨 · 任破一节延后重击",
    actions: {
      jointCrush: { name: "千节压身", icon: "节", kind: "attack", damage: 13 },
      moltSection: { name: "换节覆骨", icon: "换", kind: "charge", bonus: 8, armor: 8, armorCap: 24, interruptThreshold: 14 },
      tripleRake: { name: "三骨连耙", icon: "耙", kind: "attack", damage: 5, hits: 3 },
    },
  },
  burdenTowerTurtle: {
    name: "负塔鼋", title: "骨殖井塔主", maxHp: 162, isBoss: true,
    mechanicProfile: "tower_shell_phase", mechanicHandler: "boss_phase_window", mechanicIdentity: "三重塔壳", mechanicCounter: "破壳改变意图顺序", mechanicCounterEffect: "weaken_next_attack", mechanicWarning: "塔壳正在承压，裂开后意图顺序会改变。",
    endlessPattern: "towerShell", ecologyTags: ["armor", "corpse"], lessonKey: "crack_tower_shell", historyKey: "endless_burden_tower_turtle", def: { boneArmorStart: 24, boneArmorRegen: 4, boneArmorCap: 28 },
    kicker: "背负残塔，壳裂层移", intro: "负塔鼋背着一座倒塌石塔，三重龟壳在塔压下依次开裂。", caption: "三重塔壳 · 拖延积压",
    actions: {
      towerRam: { name: "负塔冲撞", icon: "撞", kind: "attack", damage: 14 },
      shellPress: { name: "塔壳沉降", icon: "壳", kind: "charge", bonus: 10, armor: 10, armorCap: 32, interruptThreshold: 16 },
      fallingStone: { name: "落塔石雨", icon: "落", kind: "attack", damage: 7, hits: 2 },
    },
  },
  returningTideMushroom: {
    name: "返潮尸蕈", title: "瘴潮腹回生", maxHp: 66,
    mechanicProfile: "returning_tide", mechanicHandler: "trigger_window", mechanicTrigger: "debuff_empty", mechanicIdentity: "返潮回生", mechanicCounter: "保留任意减益压潮", mechanicCounterEffect: "weaken_next_attack",
    endlessPattern: "debuffTide", ecologyTags: ["decay", "corpse"], lessonKey: "keep_debuff_tide", historyKey: "endless_returning_tide_mushroom",
    kicker: "潮退菌醒，无痕则生", intro: "返潮尸蕈的菌盖干瘪发白，只等身上最后一缕减益消失便回潮再生。", caption: "无减益则回生 · 留痕可压潮",
    actions: {
      sporeSlap: { name: "尸蕈拍击", icon: "蕈", kind: "attack", damage: 9 },
      dampGuard: { name: "湿膜护体", icon: "湿", kind: "defend", block: 8 },
      tideBreath: { name: "返潮吐息", icon: "潮", kind: "attack", damage: 6, playerPoison: 2 },
    },
  },
  poisonDrinkingTick: {
    name: "饮毒蜱", title: "瘴潮腹毒囊", maxHp: 62,
    mechanicProfile: "poison_belly", mechanicHandler: "stack_growth", mechanicIdentity: "饮毒腹囊", mechanicCounter: "控制施毒或备甲接爆", mechanicCounterEffect: "clear_stacks",
    endlessPattern: "poisonBelly", ecologyTags: ["decay"], lessonKey: "manage_poison_belly", historyKey: "endless_poison_drinking_tick",
    kicker: "吞毒三口，腹满将裂", intro: "饮毒蜱的腹囊半透明，每回合最多吞下三层毒，涨满前必会预告。", caption: "每回合吞毒3层 · 腹满后爆裂",
    actions: {
      needleBite: { name: "蜱针噬咬", icon: "针", kind: "attack", damage: 8 },
      bellyPulse: { name: "腹囊搏动", icon: "囊", kind: "charge", bonus: 5, interruptThreshold: 11 },
      poisonBurst: { name: "毒腹爆裂", icon: "爆", kind: "attack", damage: 10, playerPoison: 2, bellyBurst: true },
    },
  },
  mistLungFrog: {
    name: "雾肺蛙", title: "瘴潮腹蓄瘴", maxHp: 68,
    mechanicProfile: "mist_lung_charge", mechanicHandler: "interrupt", mechanicIdentity: "鼓肺蓄瘴", mechanicCounter: "吸气回合足额重创", mechanicCounterEffect: "clear_charge",
    endlessPattern: "mistCharge", ecologyTags: ["decay"], lessonKey: "interrupt_mist_lung", historyKey: "endless_mist_lung_frog",
    kicker: "雾入肺腑，呛断则散", intro: "雾肺蛙鼓起半透明瘴肺，吸气声越长，下一轮连击越密。", caption: "蓄瘴可打断 · 未断则连击",
    actions: {
      tongue: { name: "雾舌", icon: "舌", kind: "attack", damage: 9 },
      inhale: { name: "鼓肺吸瘴", icon: "吸", kind: "charge", bonus: 9, interruptThreshold: 13 },
      miasmaVolley: { name: "连雾喷吐", icon: "雾", kind: "attack", damage: 4, hits: 3, playerPoison: 2 },
    },
  },
  marshLampMoth: {
    name: "沼灯孽蛾", title: "瘴潮腹精英", maxHp: 105, isElite: true,
    mechanicProfile: "lamp_card_mark", mechanicHandler: "trigger_window", mechanicTrigger: "lamp_marked", mechanicIdentity: "灯粉照类", mechanicCounter: "主动轮换牌类熄灯", mechanicCounterEffect: "clear_stacks",
    endlessPattern: "cardTypeLamp", ecologyTags: ["decay"], lessonKey: "extinguish_card_lamp", historyKey: "endless_marsh_lamp_moth",
    kicker: "灯粉照类，同式愈明", intro: "沼灯孽蛾撒下灯粉，重复同一牌类会让灯焰越烧越旺。", caption: "同类牌养灯 · 换类即熄",
    actions: {
      lampDust: { name: "灯粉扑面", icon: "粉", kind: "attack", damage: 8, playerPoison: 2 },
      wingFlare: { name: "孽翅灼闪", icon: "翅", kind: "attack", damage: 11 },
      kindleLamp: { name: "沼灯引火", icon: "灯", kind: "charge", bonus: 7, interruptThreshold: 13 },
    },
  },
  rotTideMirageMother: {
    name: "腐潮蜃母", title: "瘴潮腹塔主", maxHp: 158, isBoss: true,
    mechanicProfile: "rot_tide_phase", mechanicHandler: "boss_phase_window", mechanicIdentity: "干潮涨潮", mechanicCounter: "按潮相切换爆发与留毒", mechanicCounterEffect: "weaken_next_attack", mechanicWarning: "潮相即将翻转，下一回合的弱点会改变。",
    endlessPattern: "tidePhases", ecologyTags: ["decay"], lessonKey: "read_rot_tide", historyKey: "endless_rot_tide_mirage_mother",
    kicker: "潮相翻腹，毒卵浮沉", intro: "腐潮蜃母在干潮与涨潮间翻动腹腔，减益会在涨潮时凝成瘴卵。", caption: "干潮怕爆发 · 涨潮化减益",
    actions: {
      dryClaw: { name: "干潮裂爪", icon: "干", kind: "attack", damage: 13 },
      floodBrood: { name: "涨潮孵瘴", icon: "涨", kind: "charge", bonus: 8, interruptThreshold: 15 },
      mirageWave: { name: "蜃潮拍岸", icon: "蜃", kind: "attack", damage: 6, hits: 2, playerPoison: 2 },
    },
  },
  lotSwallowingSpider: {
    name: "吞签蛛", title: "逆契回廊封签", maxHp: 64,
    mechanicProfile: "hand_lot_mark", mechanicHandler: "trigger_window", mechanicTrigger: "lot_marked", mechanicIdentity: "吞签封牌", mechanicCounter: "打出或弃掉被标记牌", mechanicCounterEffect: "clear_mark",
    endlessPattern: "handMark", ecologyTags: ["pact"], lessonKey: "clear_lot_mark", historyKey: "endless_lot_swallowing_spider",
    kicker: "蛛丝点签，滞手即封", intro: "吞签蛛吐出一根写满命纹的丝，缠住你手里的一张蛊牌。", caption: "标记公开 · 留手则封一回合",
    actions: {
      silkBite: { name: "签丝噬咬", icon: "签", kind: "attack", damage: 9 },
      sealWeb: { name: "封签结网", icon: "封", kind: "attack", damage: 6, handSizePenalty: 1 },
      hangLot: { name: "悬签蓄势", icon: "悬", kind: "charge", bonus: 7, interruptThreshold: 12 },
    },
  },
  marrowBurningHound: {
    name: "焚髓犬", title: "逆契回廊咬寿", maxHp: 70,
    mechanicProfile: "marrow_bite", mechanicHandler: "mark_then_strike", mechanicIdentity: "无甲焚髓", mechanicCounter: "重咬前保留一点护甲", mechanicCounterEffect: "weaken_next_attack",
    endlessPattern: "armorChecksLife", ecologyTags: ["pact"], lessonKey: "guard_marrow_bite", historyKey: "endless_marrow_burning_hound",
    kicker: "甲存护髓，甲空啃寿", intro: "焚髓犬的獠牙烧着白焰，只会在你无甲时咬进寿骨。", caption: "无甲才损寿 · 留甲可挡",
    actions: {
      ashBite: { name: "灰牙", icon: "牙", kind: "attack", damage: 10 },
      marrowBite: { name: "焚髓重咬", icon: "髓", kind: "attack", damage: 13, lifespanDamageIfNoArmor: 1 },
      circleAsh: { name: "绕灰", icon: "绕", kind: "defend", block: 8 },
    },
  },
  mirrorFateSilkworm: {
    name: "镜命蚕", title: "逆契回廊记式", maxHp: 72,
    mechanicProfile: "mirror_card_type", mechanicHandler: "trigger_window", mechanicTrigger: "type_remembered", mechanicIdentity: "镜壳记式", mechanicCounter: "主动轮换牌类", mechanicCounterEffect: "clear_mark",
    endlessPattern: "rememberCardType", ecologyTags: ["pact"], lessonKey: "rotate_mirror_type", historyKey: "endless_mirror_fate_silkworm",
    kicker: "昨式成镜，今式受阻", intro: "镜命蚕的薄壳映出你上一回合最常用的牌类，并在本回合抵住同类伤害。", caption: "记住上回合牌类 · 同类减伤",
    actions: {
      mirrorThread: { name: "镜丝", icon: "镜", kind: "attack", damage: 8 },
      shellGleam: { name: "命壳反光", icon: "壳", kind: "defend", block: 9 },
      fateShear: { name: "剪命", icon: "剪", kind: "attack", damage: 10, energyDrain: 1 },
    },
  },
  myriadEyeCovenantBeast: {
    name: "万目契兽", title: "逆契回廊精英", maxHp: 112, isElite: true,
    mechanicProfile: "action_prediction", mechanicHandler: "trigger_window", mechanicTrigger: "prediction_hit", mechanicIdentity: "万目预判", mechanicCounter: "故意改变出牌节奏", mechanicCounterEffect: "clear_mark",
    endlessPattern: "predictCardType", ecologyTags: ["pact"], lessonKey: "fool_covenant_prediction", historyKey: "endless_myriad_eye_covenant_beast",
    kicker: "万目先睁，猜中才强", intro: "万目契兽在你出牌前公开它的预测；只有猜中，眼群才会一齐发亮。", caption: "预测公开 · 骗过便无强化",
    actions: {
      eyeRake: { name: "万目爪", icon: "目", kind: "attack", damage: 12 },
      foresee: { name: "契目预判", icon: "预", kind: "charge", bonus: 8, interruptThreshold: 14 },
      gazeVolley: { name: "群目灼视", icon: "视", kind: "attack", damage: 5, hits: 2, energyDrain: 1 },
    },
  },
  reverseBornTowerFetus: {
    name: "倒生塔胎", title: "逆契回廊塔主", maxHp: 168, isBoss: true,
    mechanicProfile: "borrowed_echoes", mechanicHandler: "boss_phase_window", mechanicIdentity: "三段旧敌回响", mechanicCounter: "按公开回响顺序准备", mechanicCounterEffect: "weaken_next_attack", mechanicWarning: "塔胎正在翻出本局旧敌回响，顺序已公开。",
    endlessPattern: "borrowRecent", ecologyTags: ["pact"], lessonKey: "outlast_three_echoes", historyKey: "endless_reverse_born_tower_fetus",
    kicker: "倒生借形，旧敌再响", intro: "倒生塔胎从你本局见过的敌人身上借来三段回响，每段只会使用一次。", caption: "三段回响公开 · 各用一次",
    actions: {
      fetalPulse: { name: "倒生搏动", icon: "胎", kind: "attack", damage: 14 },
      borrowEcho: { name: "借形回响", icon: "借", kind: "charge", bonus: 9, interruptThreshold: 16 },
      towerReversal: { name: "逆塔翻身", icon: "逆", kind: "attack", damage: 7, hits: 2, lifespanDamageIfNoArmor: 1 },
    },
  },
  wanmingMupan: {
    name: "万命母盘",
    ...
    mechanicProfile: "habit_rewrite", mechanicHandler: "boss_phase_window", mechanicWarningSignal: "mupan_habit_warning", mechanicTransitionSignal: "mupan_habit_window", mechanicIdentity: "习惯照见", mechanicCounter: "照见亮起时重创盘心", mechanicCounterEffect: "weaken_next_attack", mechanicWarning: "母盘已公开当前照见的习惯；改变节奏或立刻重创，皆可夺回一线。",
    kicker: "万命归盘，旧债成签",
...
const ORDINARY_RELICS = Object.freeze({
  ...
  fateCoin: {
    ...
    description: "命势圆满时，额外获得 1 点防御；每场前 3 次圆满各得 1 蛊石，每场最多 3 枚蛊石。",
  },
  shopContract: {
